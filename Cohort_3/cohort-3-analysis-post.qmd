...
cohort3FinalGov <- read.csv("~/Documents/R_Projects/TOPC-impact-evaluation-dashboard/Cohort_3/cohort3FinalGov2.csv") 
...
```{r}
#| label: agreement-likert-scale-conversion
#| message: false

likert_columns <- c("q4", "q5", "q6", "q7", "q9", "q10", "q11", "q12", "q13", "q14", "q15", "q16", "q17", "q20", "q21")
for (col in likert_columns) {
  cohort3FinalGov[[col]] <- as.numeric(factor(cohort3FinalGov[[col]],
                                             levels = c('Strongly disagree', 'Disagree', 'Agree', 'Strongly agree'),
                                             labels = c(1, 2, 3, 4)))
}

# Check the data types after conversion
sapply(cohort3FinalGov[likert_columns], class)

# Check if conversion worked correctly
summary(cohort3FinalGov[likert_columns])
```
...
# # Unweighted count
# unweighted_counts <- table(cohort3FinalGov$q3)
# 
# # Weighted count
...
all_levels_df <- data.frame(q21 = factor(1:4, levels = 1:4), Freq = character(4))
