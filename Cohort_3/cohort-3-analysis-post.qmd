...
```{r}
#| label: likert-scale-weights
#| message: false
# Assign weights to responses
weight_mapping <- c("Strongly agree" = 4, "Agree" = 3, "Disagree" = 2, "Strongly disagree" = 1)

# Map the responses in the survey data to their weights
cohort3FinalGov$WeightedValue <- weight_mapping[cohort3FinalGov$q4]

# Check if the mapping worked correctly
# print(head(cohort3FinalGov))
```
