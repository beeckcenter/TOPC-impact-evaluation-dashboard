...
-   <div>
    ...
    cohort3FinalGov <- read.csv("~/Documents/R_Projects/TOPC-impact-evaluation-dashboard/Cohort_3/cohort3FinalGov3.csv") 
...
# questions_to_analyze <- c("q4", "q5", "q6", "q7", "q9", "q10", "q11", "q12", "q13", "q14", "q15", "q16", "q17", "q20", "q21")
# 
# # Define the strata
...
#     stratum_data <- subset(cohort3FinalGov, city_mapped == stratum)
#     stratum_stats <- list()
